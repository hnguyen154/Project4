...
//-------------------------------------------------------Updating-----------------------------------------------------------------------------
        ...
        view.addSearchAnimalActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else if(db.ConstrainName(view.getSearch())) {
        ...
        view.addAddAnimalActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (view.getAddName().equals("")&& view.getAddType().equals("") && view.getAddLocation().equals("")){
                    JOptionPane.showMessageDialog(null,"No Values!","Error",JOptionPane.ERROR_MESSAGE); 
                }
                else{
                    try {
                        if (db.ConstrainName(view.getAddName())){
                            JOptionPane.showMessageDialog(null,"This name exits!","Congratulation",JOptionPane.INFORMATION_MESSAGE); 
                        }else{
                            //Add to database
